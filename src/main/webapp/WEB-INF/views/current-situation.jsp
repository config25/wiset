  ...
  <div class="section" style="padding:20px 40px 56px;">
    ...
    <div style="max-width:860px; margin:16px auto 0;">
      ...
      <div class="card mt-16" style="padding:22px;">
        ...
        <div class="row items-center gap-12" style="padding:14px 16px; border:1px solid var(--pink-100); border-radius:10px; background:linear-gradient(90deg, var(--pink-50) 0%, #fff 100%);">
          <wb:iconchip name="sparkle" tone="pink" size="38" icon="18" radius="9" />
          <div style="flex:1;">
            <div class="fw-700" style="font-size:13px;">1:1 커리어컨설팅 데이터 <span class="t-pink">3건</span> 발견</div>
          </div>
        </div>
      </div>
