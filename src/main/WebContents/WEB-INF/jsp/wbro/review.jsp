...
(function () {
  ...
  // 1:1 커리어컨설팅 Q&A (세션 사용자 기준) — 건수 요약용
  function cnsl(){ return fetch(ctx+'/indvdl/cnsl/selectCnslQnaList.do').then(function(r){return r.ok?r.json():[];}).catch(function(){return [];}); }
  ...
  Promise.all([
    ...
    var sec2 = { n:'02', t:'현 상황', step:2, edit:'/current-situation', rows:[
      ...
      // 1:1 커리어컨설팅 Q&A 연동 (TN_CNSL_REQST_INFO). 없으면 '미입력'.
      row('컨설팅 결과', cnslList.length? ('1:1 커리어컨설팅 데이터 '+cnslList.length+'건 연동') : null),
