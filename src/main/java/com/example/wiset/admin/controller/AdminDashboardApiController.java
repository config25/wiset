...
import com.example.wiset.admin.service.impl.AdminDashboardServiceImpl;
 ...
 *   @Resource(name="adminDashboardService"), @RequestMapping("/mngr/admin/...do"), @RequestParam Map+ModelMap,
 *   조회는 return "jsonView". (서비스/매퍼는 이미 wbridge idiom: CommonDAO + mngr.adminDashboard.*)
 */
@RestController
...
public class AdminDashboardApiController {
    ...
    public AdminDashboardApiController(AdminDashboardServiceImpl service) {
