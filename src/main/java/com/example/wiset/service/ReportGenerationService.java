 ...
 *   AI 호출(느린 HTTP)은 트랜잭션 밖, 적재만 ReportPersistService 에서 트랜잭션 처리.
 */
@Slf4j
@Service
public class ReportGenerationService {
    ...
    private final ReportPersistService persistService;
    private final ReportInputAssembler assembler;
    private final ObjectMapper om = new ObjectMapper();

    public ReportGenerationService(WisetAiClient ai,
                                   @Qualifier("aiExecutor") ExecutorService exec,
                                   ReportPersistService persistService,
    ...
    public Map<String, Object> generate(GenerationInputs in) {
