...
import com.example.wiset.report.service.impl.ActivityAnalysisServiceImpl;
...
public class ActivityAnalysisApiController {
    ...
    private final ActivityAnalysisServiceImpl service;

    public ActivityAnalysisApiController(ActivityAnalysisServiceImpl service) {
